...
for [invoke](https://www.pyinvoke.org/)
...
1. When a new version of [invoke](https://www.pyinvoke.org/) releases,
...
2. An update of `doc-requirements.txt` will trigger the docs to build
   on the newest tagged release of [invoke](https://www.pyinvoke.org/)
   (`nox --tags build`).
